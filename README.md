...
For this one you need to have llama3.2:3b (you can change the size in the code. you can use qwen2.5 (0.5b, 1.5b, 3b, 7b, ...) you can use llama3.2:1b (1b) or deepseek-r1 (1.5b, 7b, 8b, ...)) 

And nomic-embed-text (you can change this too (some examples if you want smaller models are : all-minilm (33m), all-minilm:22m (22m) and if you want a larger model mxbai-embed-large (335m)).
